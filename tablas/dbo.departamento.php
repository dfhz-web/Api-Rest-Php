            ...
            <table id="example" class="display table" style="width:100%">
                ...
                <tbody>
                   <?php $arrContextOption = $arrayName = array('ssl' => array("verify_peer"=>false,"verify_peer_name"=>false,), );
                        $json=file_get_contents('http://186.80.212.253:8081/api/departamento/',false,stream_context_create($arrContextOption));
                        $datos=json_decode($json,true);

                        foreach ($datos as $key => $row_per) {
                        ?>
                        <tr>
                            <td><?php echo $row_per['id_departamento']; ?></td>
                            ...
                            <td>
                                <a href="departamento/eliminar.php ?id=<?php echo $row_per['id_departamento']; ?>" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
    ...
    <div class="modal fade" id="modal_agregar_persona" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <form action="departamento/insert.php" class="form-group" method="POST">
